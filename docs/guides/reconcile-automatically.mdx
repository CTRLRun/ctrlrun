...
description: "Give @protect a reconcile hook that asks the remote what happened to an effect key, and CTRLRun moves an AMBIGUOUS record to COMMITTED or FAILED on its own, only in the direction the answer points."
---
