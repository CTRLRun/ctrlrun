---
title: "Three ways in"
description: "The @protect decorator covers anything in your Python process, the MCP gateway covers tools behind an MCP server in any language, and an adapter routes an approval through a framework's own interrupt. Most readers need the decorator."
---
