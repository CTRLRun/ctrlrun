...
description: "Every key of the authority: section: max_delegation_depth and grants, and on a grant id, subject (agent, user), actions, resources, constraints, environments, delegable and expires_at, with what omitting each one means."
---
