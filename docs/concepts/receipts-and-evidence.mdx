...
description: "A receipt is a portable JSON record of one executed action: who, what, the decision, the approval, the effect key, the outcome and the hash of the policy that decided it, chained to the receipt before it and written beside the store as JSON lines."
---
