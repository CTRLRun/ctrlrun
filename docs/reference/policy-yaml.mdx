...
description: "Every key of ctrlrun.yaml, from ctrlrun.policy/v1 to v4: schema, actions, decision, rules, when conditions and their seven operators, effect and resource templates, mcp, mode, environment, authority, version, controls and data, with the fail-closed behaviour when each is omitted."
---
