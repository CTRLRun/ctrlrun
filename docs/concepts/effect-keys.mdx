---
title: "Effect keys"
description: "An effect key names the real-world consequence of an action, such as refund:txn_1, so that a retry, a second agent or a second host proposing the same consequence is one effect, reserved atomically and executed at most once."
---
