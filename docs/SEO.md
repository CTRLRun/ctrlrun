...
| `mcp/approve-from-your-assistant` | approve MCP tool call from Claude · MCP human approval server | Run `ctrlrun mcp-operator` and answer a pending approval from an MCP client, under your own name. |
