...
description: "Protect one function end to end: write a policy, decorate the call, watch a small refund run, a large one wait for a human, an approval bind to the exact action, and read the receipt."
---
