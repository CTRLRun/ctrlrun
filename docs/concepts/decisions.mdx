---
title: "Decisions"
description: "A decision is one of allow, approve or deny, made per action by a policy that matches rules first-wins over the action's arguments and cannot see who is asking."
---
