---
title: "Install"
description: "pip install ctrlrun puts one package, pyyaml and click on your machine, nothing else. Python 3.11 or later. Extras add the gateway, identity, OpenTelemetry and Postgres."
---
