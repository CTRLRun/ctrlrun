...
would rather see it before you type it, [Try it in your browser](/try-it) runs the five demo
...
- [Cookbook](/cookbook/index): the same shape for a deploy, an IAM grant, a deletion, an email, an MCP server.
