...
description: "In-process Python: the decorator. Tools behind MCP: the gateway. A framework with its own approval UI: an adapter. For one host you need no server, no database and no dashboard."
---
