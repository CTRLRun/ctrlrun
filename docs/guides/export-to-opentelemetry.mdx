...
description: "Add OTelEventSink to a Control and every action becomes one span with one span event per step, in whatever tracing backend your process already exports to; argument values stay out unless you ask."
---
