...
description: "An action is a named operation with canonical arguments, a resource, a principal and an environment; its SHA-256 is the action hash, the value an approval binds to."
---
