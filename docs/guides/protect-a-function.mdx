...
description: "Wrap the function that acts with @ctrlrun.protect, name the action and its effect key, say who is acting, and watch a small change run, a large one wait for a human, and a duplicate be refused."
---
...
<Steps>
  ...
  <Step title="Read what happened">
    ...
    Every call has a receipt, refused ones included, and every effect key has a state. The
