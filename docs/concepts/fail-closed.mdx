---
title: "Fail closed"
description: "Fail closed means anything CTRLRun cannot decide is denied: an unknown action, a missing or malformed policy, a missing or expired principal, a missing, expired or mismatched approval, an inconsistent store. No flag makes a consequential action permissive by default."
---
