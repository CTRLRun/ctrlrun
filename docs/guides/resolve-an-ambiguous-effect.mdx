...
description: "Find the effects nobody knows the outcome of with ctrlrun effects, ask the remote what happened, say so with ctrlrun resolve --committed or --failed, and read who resolved it in the receipt."
---
